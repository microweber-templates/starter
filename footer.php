            ...
            <div id="footer-bottom-wrapper">
                <div class="container">
                    <div id="footer-bottom">
                        <div class="row">
                            <div class="col-md-8" class="edit nodrop safe-mode" field="starter_footer" rel="global">
                                <div>
                                    Copyright &copy; <span class="unselectable" contentEditable="false"><?php print date('Y'); ?></span>, All rightsreserved
                                </div>
                            </div>
